...
"""
        ...
        code(
            ...
            '"pandas==2.2.2" "scikit-learn>=1.2,<1.9" "requests==2.32.4" '
            '"pillow>=8,<12" tqdm "wfdb==4.1.2" joblib matplotlib seaborn packaging '
...
planned = {
    'MiniRocket-only': 'python -u scripts/revision/10_minirocket_only_baseline.py --oof-predictions reports/revision/predictions/oof_final_ema_predictions.npz --freeze-manifest reports/revision/manifests/oof_final_ema_freeze_manifest.json --expected-checkpoint-kind final_ema --threshold 0.5 --n-bins 15 --n-boot 1000 --backend torch_linear --torch-epochs 20 --batch-size 4096 --stats-batch-size 1024 --lr 1e-3 --weight-decay 1e-4 --standardize train_fold --device auto',
