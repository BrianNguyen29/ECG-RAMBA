...
REVIEWED_RUNNER_COMPATIBILITY: dict[str, dict[str, Any]] = {
    "minirocket": {
        ...
        "compatible_current_source_bundle_sha256": "ed986a10c48275db64d08ecaffbb3a2e2787700157ee36f8133a186157737524",
        ...
        "review_scope": (
            ...
            "comparator-contract reporting, and provenance-only drift; the fixed-seed "
    ...
    "resnet": {
        ...
        "compatible_current_source_bundle_sha256": "7beb56157b389074376bb8791405a24317eb6e249641ba16c09f48fe956314d0",
        "expected_manifest_sha256": "486dc2e9ebc634f52b62312e23727b5bb0107522a992fc03cef4800f78af880b",
        "expected_summary_sha256": "3db0d738fc103cbceacc81f921c4e70eba3050356e46522ba54e1efdaf7acd4f2",
        ...
        "review_scope": (
            ...
            "reporting and legacy Transformer checkpoint metadata validation-only drift; "
    ...
    "raw_mamba": {
        ...
        "compatible_current_source_bundle_sha256": "f067d8fdc81554e5ba2d84408349b31b3f9060bd4bc9ffd1b013d09f738f0581",
        ...
        "review_scope": (
            ...
            "comparator-contract reporting, and provenance-only drift; Raw Mamba prediction "
    ...
    "transformer": {
        ...
        "compatible_current_source_bundle_sha256": "60b91c735f02777c6ddb46c7ba4b41721e36f56d61cca58e15d8092dc934055f",
        ...
        "review_scope": (
            ...
            "pipeline metadata/provenance drift; Transformer prediction semantics are unchanged"
        ),
    },
    "hybrid": {
        ...
        "compatible_current_source_bundle_sha256": "cb16639e3d7abaa1eb41ef2b73edaab6d33866f35e448f6004e5a5be09cda6f7",
        ...
        "review_scope": (
            "exact package and executable source bundle reviewed across comparator-contract "
            "reporting and provenance-only drift; frozen-transform morphology MLP predictions "
            "are unchanged"
        ),
    },
}
