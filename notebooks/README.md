...
3. `02a_retrain_best_ema.ipynb`
4. `02_predictions_and_external_eval.ipynb`
5. `03_calibration_and_ci.ipynb`
6. `06_pooling_and_representation.ipynb` (pooling sensitivity)
7. `04_baselines_and_component_checks.ipynb`
8. `05_hrv_domain_and_robustness.ipynb`
9. Revisit `06_pooling_and_representation.ipynb` for representation work.
10. `07_results_freeze.ipynb`
